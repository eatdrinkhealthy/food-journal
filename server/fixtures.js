if (JournalEntries.find().count() === 0) {
    ...
    je1.set('_id', new Date(2015, 8, 23));  // note/remember, month is zero based
    je1.set('caption', 'good day.');
    je1.save();

    var je2 = new JournalEntry();
    je2.set({
        _id: new Date(2015, 8, 21),
